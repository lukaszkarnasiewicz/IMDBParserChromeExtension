This is a Chrome extension that parses/scrapes an IMDB movie page and prints out the movie metadata (title, URL, genre, rating, runtime) as a semicolon separated list. <br/>
